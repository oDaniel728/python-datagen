...
class EnchantmentProvider(ToDict):
    ...
    def with_attributes(self, *attributes: ToDict) -> Self:
        ...
        for attr in attributes:
            self._data["effects"]["minecraft:attributes"].append(attr.to_dict() if hasattr(attr, "to_dict") else attr)
        return self
    ...
    def with_damage_immunity(self, requirements: dict | None = None) -> Self:
        ...
        return self.with_effect("minecraft:damage_immunity", entry)
    ...
    def with_trident_sound(self, *sounds: str) -> Self:
        return self.with_effect("minecraft:trident_sound", *sounds)
